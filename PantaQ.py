...
class PantaQ():
    ...
    def set_future_orders(self, settle, contract, size, iceberg=None, price=None, close=None, reduce_only=None, tif=None, text=None, auto_size=None):
        return self.exchange.set_future_orders(settle, contract, size, iceberg, price, close, reduce_only, tif, text, auto_size)
    ...
    def cancle_future_orders(self, settle, contract, side):
        return self.exchange.cancle_future_orders(settle, contract, side)

    def make_future_orders(self, orders, contract, size, iceberg=None, price=None, close=None, reduce_only=None, tif=None, text=None, auto_size=None):
        return self.exchange.make_future_orders(orders, contract, size, iceberg, price, close, reduce_only, tif, text, auto_size)
    ...
    def cancle_future_ofders_with_id(self, settle, order_id):
        return self.exchange.cancle_future_ofders_with_id(settle, order_id)

    def update_future_ofders_with_id(self, settle, order_id):
        return self.exchange.update_future_ofders_with_id(settle, order_id, size, price)
    
    def get_future_my_trades(self, settle, contract=None, order=None, limit=None, offset=None, last_id=None, count_total=None):
    ...
    def set_future_price_orders(self, settle, contract, price, size=None, close=None, tif=None, text=None, reduce_only=None, auto_size=None, strategy_type=None, price_type=None, trigger_price=None, rule=None, expiration=None, order_type=None):
    ...
    def cancle_future_price_orders_with_id(self, settle, order_id):
        return self.exchange.cancle_future_price_orders_with_id(settle, order_id)
